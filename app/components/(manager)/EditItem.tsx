...
export function EditItem({ href }: { href: string }) {
    ...
    return (
        <Link onClick={() => setIsLoading(true)} className="absolute button-theme-primary rounded-full z-10 bottom-0 right-0 mr-2 mb-2" aria-label="Edit" role="button" tabIndex={-1} href={href}>
